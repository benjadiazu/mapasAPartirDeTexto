...
public:
    ...
    void addCityAt(std::string cityName, std::string territoryName, double nx, double ny);
    void addTownAt(std::string townName, double nx, double ny);
...
private:
    ...
    int _getFaceAtPoint(double nx, double ny);
    void _ensureLandAt(double nx, double ny);
